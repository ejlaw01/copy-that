    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-2xl px-6 py-10">
        ...
        <div className="space-y-6 text-sm text-foreground/70 leading-relaxed">
          ...
          <section>
            <h2 className="text-base font-medium text-foreground mb-2">What I collect</h2>
          ...
          <section>
            <h2 className="text-base font-medium text-foreground mb-2">What I don&apos;t collect</h2>
            <ul className="list-disc list-inside space-y-1">
          ...
          <section>
            <h2 className="text-base font-medium text-foreground mb-2">AI processing</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-medium text-foreground mb-2">Marketing emails</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-medium text-foreground mb-2">Bot protection</h2>
            <p>
